...
//!
//! Every atom goes through [`AtomParams::render`] — rfofs's `FofState` for a FOF, [`rmp_core::gauss`]
...
use rmp_core::fof::{AtomParams, Envelope, FofError};
...
mod tests {
    ...
    fn a_mixed_book_renders_as_the_sum_of_its_atoms() {
        ...
        for a in atoms {
            ...
            rmp_core::signal::add_at(&mut want, &one, a.t0);
        }
