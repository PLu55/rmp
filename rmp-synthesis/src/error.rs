...
//!
//! The messages name the CLI flag the user typed, the way [`rmp_core::residual::error`] names the
...
use rmp_core::audio::AudioError;
use rmp_core::fof::FofError;
use rmp_core::residual::book::ErbFilterKind;
use rmp_core::residual::error::ResidualAnalysisError;
